...
namespace TeamMatching.Web.Services
{
    ...
    public interface IMyActivitiesService
    {
        ...
        // 팀원평가
        Task<GetReviewTargetResponse> GetReviewTargetAsync(GetReviewTargetRequest request, int userId);
        
        // 팀원평가 제출
        Task<SubmitReviewResponse> SubmitReviewAsync(SubmitReviewRequest request, int userId);
